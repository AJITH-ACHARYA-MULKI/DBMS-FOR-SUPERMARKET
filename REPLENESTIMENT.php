...
<fieldset>
<legend><h3><i>Stock Replenishment Request</i></h3></legend>
...
<table align="center" border="5"  cols="7" cellpadding="4" cellspacing="4" hspace="20" vspace="20">
				...
				<td align="justify" ><input name="DATE" placeholder="mm/dd/yyyy" type=""></td>
				</tr>
...
$sql="INSERT INTO replenishment VALUES('$REQUEST_ID','$SUPPLIER_ID','$DATE','$TYPE','$ITEM_ID','$QTY');";  
...
?> 
<center> <a href="abc.php">
		<input type="submit" value="view Stock details">
	</a>
</center>
</body>
